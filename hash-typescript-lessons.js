...
const sourcePath = path.join(__dirname, 'lessons-typescript-source.json');

if (!fs.existsSync(sourcePath)) {
    console.error('Error: lessons-typescript-source not found!');
    process.exit(1);
}
...
const outputPath = path.join(__dirname, 'public', 'assets', 'data', 'lessons-typescript.json');
